...
function createMockCtx() {
  ...
  return { ctx: { req: {}, res, state: {} } as any, res };
}
...
describe('ErrorHandler', () => {
  describe('setErrorHandler()', () => {
    ...
    it('should throw TypeError if argument is not a function', () => {
      ...
      expect(() => eh.setErrorHandler('not-fn' as any)).toThrow(TypeError);
      expect(() => eh.setErrorHandler('not-fn' as any)).toThrow(
  ...
  describe('handle() — custom handler', () => {
    it('should delegate to custom handler', async () => {
      ...
      eh.setErrorHandler((err: any, ctx: any) => {
    ...
    it('should support async custom handler', async () => {
      ...
      eh.setErrorHandler(async (err: any, ctx: any) => {
